...
<div class="container bg-light mt-2">
   <div class="row">
        <ol class="col-12 breadcrumb">
                ...
                <li class="breadcrumb-item active" href="#">Check Status</li>
        </ol>
   </div>
   <div class="row">
	   ...
	   <div class="row mt-3" style="height:350px">
	       <div class="col-12 col-sm-9 offset-sm-1" id="register_div">
	          <br/>
	          <br/>
	          <p> Pending....</p>
	          <p>The process is still ongoing. The ECI body will release the status of your application soon.
	          Please check in a while. In case of any query, mail us at our id provided in the contact form.</p>
	       </div>
	       <div class="col-12 col-sm-2">
	          <a href="#" >Help?</a><br/>
